...
<html lang="en">
    <head>
        ...
        <title>JTY HOSTEL - The Height Resident</title>
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Dashboard > View The Height Resident</li>
                        </ol>
							
						<div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-table mr-1"></i>
                                View The Height Resident
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
										...
										<?php
										$i=1;
                                            $result=mysqli_query($connect,"select * from hostel where TotRoom >0 and HostelIsDelete=0 and Cat_id='3'");
