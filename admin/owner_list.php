...
$result=mysqli_query($connect,"select * from owner where OwnerIsDelete=0 ");
...
<html lang="en">
    <head>
        ...
        <title>JTY HOSTEL - Owner List</title>
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Dashboard > Owner List</li>
                        </ol>
                            ...
                            <div class="card-header">
                                ...
                                Owner List
												<form method="post" action="export.php">
													<input class="btn btn-info btn-sm"  style="margin-left:2em; float:right;"  type="submit" name="exown" value="Export Owner list to Excel" >
												</form>
												<a class="btn btn-danger btn-sm" style="margin-left:2em; float:right;" href="owner_delete.php"><i class="fas fa-user"></i> View Removed Owner</a>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row["owner_email"] ?></td>
																	<td><a class="btn btn-primary btn-sm" href="view_owner.php?id=<?php echo $row['owner_id']?>">
																		<i class="fas fa-folder"> </i>View</a>
																	</td>
																	<td><a class="btn btn-danger btn-sm" href="owner_list.php?id=<?php echo $row['owner_id']; ?>" onclick="return confirmation()">
...
<script>
	  ...
	  <?php
		if(isset($_GET["id"]))			
		{
			$Id=$_GET["id"];
			$aid = $userData["Admin_id"];
			mysqli_query($connect,"update owner set OwnerIsDelete=1, AdminDel='$aid' where owner_id='$Id'");
	  ...
	  ?>
			...
			swal({title: "Successful Delete!",
				  icon: "success",
				  button: "Review"}).then(function(){window.location.href = "owner_delete.php";});
			</script>
	  <?php
			$subject = "Notice";
