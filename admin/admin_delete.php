...
$result=mysqli_query($connect,"select * from admin where AdminIsDelete=1 ");
...
<html lang="en">
    <head>
        ...
        <title>JTY HOSTEL - Admin List (Removed)</title>
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Dashboard > Admin Blacklist</li>
                        </ol>
						...
						<div class="card mb-4">
                            <div class="card-header">
                                ...
                                Admin Blacklist
								<a class="btn btn-warning btn-sm" style="margin-left:2em; float:right;" href="admin_list.php"><i class="fas fa-user"></i>Admin List</a>
