...
$result=mysqli_query($connect,"select * from about where Id>4 and Id<9");
...
<html lang="en">
    <head>
        ...
        <title>JTY HOSTEL - Frequently Questions</title>
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Dashboard > Frequently Asks Questions</li>
                        </ol>
						  ...
						  <?php
							...
							<div class="col-lg-6 mb-4">
							  <div class="card h-80">
								...
								<a class="btn btn-info btn-sm" href="edit_about.php?id=<?php echo $row['Id']?>">
