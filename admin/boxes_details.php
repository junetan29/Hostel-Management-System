...
<html lang="en">
    <head>
        ...
        <title>JTY HOSTEL - Details</title>
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Dashboard > INFO BOXES</li>
                        </ol>
						  ...
						  <?php
							...
							<div class="col-lg-6 mb-4">
							  <div class="card h-80">
								...
								<a class="btn btn-info btn-sm" href="edit_boxes.php?id=<?php echo $row['Id']?>">
