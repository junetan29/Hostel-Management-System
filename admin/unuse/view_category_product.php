                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Dashboard > IXORA APARTMENT</li>
                        </ol>
                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>400</td>
												<td><a class="btn btn-primary btn-sm" href="view_selected_product.php">
														  <i class="fas fa-folder">
														  </i>
														  View
													</a>
												</td>
												<td><a class="btn btn-info btn-sm" href="edit_product.php">
