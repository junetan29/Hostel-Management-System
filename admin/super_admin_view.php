				...
				                           </form>
											...
											<div class="col-sm-9">
												<ul class="nav nav-tabs">
													<li class="active"><a data-toggle="tab" href="#home"><?php echo $userData['Name']; ?>'s Profile</a></li>
											  ...
											  <div class="tab-content">
												<div class="tab-pane active" id="home">
													<br>
													  <form class="form" action="##" method="post" id="registrationForm">
														  ...
														  <div class="row">
															  ...
															  <div class="col-xl-6">
																  <label for="email"><h5>Admin Type</h5></label>
																  <p><?php echo $userData['AdminType']; ?></p>
															  </div>
														  ...
														  <div class="row">
																...
																<?php if($userData['AdminIsDelete']=="1"){ ?>
																<button class="btn btn-primary d-block px-2 py-3" name="unremove" id="btn" style="width:100%;"> Unremove</button>
																<br>
																<a href="admin_delete.php" class="btn btn-primary d-block px-2 py-3 " id="btn">Back</a>
																<br>
																<?php }
																else { ?>
																<a href="admin_list.php" class="btn btn-primary d-block px-2 py-3 " id="btn">Back</a>
																<?php }?>
													...
													if(isset($_POST["unremove"]))
													{
														...
														mysqli_query($connect,"update admin set AdminIsDelete=0, AdminDel=0 where Admin_id='$Id'");
														?>
												   ...
												   <br>
													  <form class="form"  method="post"  enctype="multipart/form-data">
														  ...
														  <div class="row">
															   <div class="col-xs-6">
																	<br>
																	<input name="updatepassword" value="Update User" type="submit" class="btn btn-primary form-control">
																</div>
																<div class="col-xs-6">
																	<br>
																	<input name="reset" value="Reset" type="reset" class="btn btn-warning form-control">
	...
	else
	{
		?>
			...
			swal({title: "Incorrect !",
				  ...
				  icon: "error",
				  button: "Retry"}).then(function(){window.location.href = "admin_list.php";});
			</script>
			<?php
	}
