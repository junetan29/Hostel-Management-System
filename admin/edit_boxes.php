...
<html lang="en">
    <head>
        ...
        <title>JTY HOSTEL - Boxes Edit</title>
                                ...
                                <div class="panel-body"><!-- panel-body Begin -->
										   ...
										   <form method="post" enctype="multipart/form-data"><!-- form-horizontal Begin --><!-- form-horizontal Begin -->
											<?php
												...
												{
												$id=$_GET["id"];
												$result=mysqli_query($connect,"select * from details where Id='$id'");
											...
											?>   
											   ...
											   <div class="form-group"><!-- form-group Begin -->
												  ...
												  <div class="col-md-12"><!-- col-md-12 Begin -->
													  ...
													  <input name="Hostel" type="text" class="form-control"  value="<?php echo $row['Hostel']?>">
											   ...
											   <div class="form-group"><!-- form-group Begin -->
												  ...
												  <div class="col-md-12"><!-- col-md-12 Begin -->
													  <textarea name="Details" cols="112" rows="6" class="form-control"><?php echo $row['Details']?></textarea>
											   ...
											   <div class="form-group"><!-- form-group Begin -->
												  ...
												  <div class="col-md-12"><!-- col-md-12 Begin -->
													...
													<div class="col-md-12"><!-- col-md-12 Begin -->
													  <a href="boxes_details.php" class="btn btn-primary form-control" id="btn">Back</a>
...
if(isset($_POST['submit'])){
    ...
    $update_answer = "update details set Hostel='$Hostel',Details='$Details' where Id='$id'";
    ...
    if($run_slide){
        ...
        echo "<script>window.open('boxes_details.php','_self')</script>";
