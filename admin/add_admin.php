...
<html lang="en">
    <head>
        ...
        <title>JTY HOSTEL - Add Insert</title>
                    ...
                    <div class="container-fluid">
						...
						<div class="card mb-4">
                            <div class="card-header">
                                <i class="fa fa-fw fa-cart-plus"></i>Add Admin 
                            </div>
                            <div class="card-body">
                                <div class="panel-body"><!-- panel-body Begin -->
										   
										   <form class="form-signin" method="post" name="registrationform" enctype="multipart/form-data"><!-- form-horizontal Begin -->
												<div class="row">
													<div class="col-xl-6">
														<label for="aname"> Admin Name </label>
														<input type="text" id="aname" name="aname" class="form-control" placeholder="Name" pattern="[A-Za-z\s]+" required>	
													</div>
												...
												<div class="row">
													<div class="col-xl-6">
														...
														<input type="text" id="aphone" name="aphone" class="form-control" placeholder="Phone Number" pattern="[0-9]+" title="digit only" required>
													</div>
													
													<div class="col-xl-6">
														<label > Admin Email </label>
														<input type="email" id="aemail" name="aemail" class="form-control" placeholder="Email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" required>
													</div>
												</div>
												<br>
												...
												<div class="form-group"><!-- form-group Begin -->
												  ...
												  <div class="col-md-12"><!-- col-md-9 Begin -->
													  ...
													  <input name="submit" value="Submit" type="submit" class="btn btn-info form-control">
													  </div><br>
													<div class="col-md-12"><!-- col-md-12 Begin -->
													  <a href="admin_list.php" class="btn btn-primary form-control" id="btn">Back</a>
...
if(isset($_POST["submit"]))
{
	...
	$check = mysqli_query($connect, "SELECT * from admin where Email = '$email'");
	$check2 = mysqli_query($connect, "SELECT * from admin where Contact = '$phnum'");
	...
	else
	{
		...
		<script type="text/javascript">
			swal({
			title: "Phone Number Is Already Exist !",
			text:"Please Change!",
			icon:"error"
			});
		</script>
		...
		else
		{
			...
			{
				$in = mysqli_query($connect, "INSERT INTO admin (Name, Email, Password, Contact, Gender, AdminType) 
				VALUES ('$name', '$email', '$pass', '$phnum', '$sex', '$sta')");
				move_uploaded_file($_FILES['profile']['tmp_name'], $target1); 
				
				?>
					<script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
					<script type="text/javascript">
					swal({title: "Admin Has Been Add  !",
						  icon: "success",
						  button: "View Admin List"}).then(function(){window.location.href = "admin_list.php";});
					</script>
					<?php
			}
		}
