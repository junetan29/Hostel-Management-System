                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Dashboard > View State</li>
                        </ol>
                                ...
                                <div class="table-responsive">
									...
									?>
                                            <tr>
												...
												<td><a class="btn btn-info btn-sm" href="edit_category.php?id=<?php echo $row['ID']?>">
