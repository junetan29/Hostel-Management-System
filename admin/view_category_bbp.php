...
$result=mysqli_query($connect,"select * from hostel where TotRoom >0 and HostelIsDelete=0 and Cat_id='2' ");
...
<html lang="en">
    <head>
        ...
        <title>JTY HOSTEL - Pangsapuri Bukit Beruang Permai</title>
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Dashboard > Pangsapuri Bukit Beruang Permai</li>
                        </ol>
							
						<div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-table mr-1"></i>
                                Pangsapuri Bukit Beruang Permai
                            </div>
                            <div class="card-body">
