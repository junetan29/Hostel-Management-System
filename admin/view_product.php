...
<html lang="en">
    <head>
        ...
        <title>JTY HOSTEL - Hostel List</title>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
										...
										<?php
										$i=1;
										$result=mysqli_query($connect,"select * from hostel where  HostelIsDelete=0");
										...
										?>
                                            <tr>
												...
												?>
												<td>
													<a class="btn btn-warning btn-sm" href="view_product.php?status2=<?php echo $row['ID']; ?>" onclick="return confirm('Do you want to Approved?')">
												...
												<td>
													...
													<i class="fas fa-times-circle "></i>	Unapprove</a>
												</td>
												...
												?>
													<td>
													<a class="btn btn-success btn-sm" href="view_product.php?status1=<?php echo $row['ID']; ?>" onclick="return confirm('Do you want to unapproved again?')">
