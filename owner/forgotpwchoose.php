...
button[type=submit]
{
  ...
  <body style="background-image: url('images/2.jpg'); background-size:100%; background-repeat:no-repeat;">
...
<div id="main-containers">
        ...
        <h3 class="card-title text-center"><b>Forgot Password</b></h3>
				<h3 class="card-title text-center"><b>Please Choose Type To Reset Password</b></h3>
								<div class="row">
									<div class="col-xl-12">
										<div class="form-label-group">
												<a href="forgotpwemail.php" id="submitbtn" name="submitbtn" class="btn btn-lg btn-primary btn-block text-uppercase signup" type="submit"><i class="fa fa-envelope-o"></i> By Email</a>
										</div>
									</div>
								</div>	
								...
								<div class="row">
									<div class="col-xl-12">
										<div class="form-label-group">
												<a href="forgotpass.php" id="submitbtn" name="submitbtn" class="btn btn-lg btn-primary btn-block text-uppercase signup" type="submit"><i class="fa fa-lock"></i> By Security Question</a>
										</div>
									</div>
								</div><br>
				</form>
