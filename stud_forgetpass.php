...
<div id="main-containers">
        ...
        <h3 class="card-title text-center"><b>Forget Password</b></h3>
								...
								<div class="row">
									<div class="col-xl-12">
										<div class="form-label-group">
											<h5><b>Please Select Your One Of Your Security Question and Answer To Change Password </b></h5>
								...
								<div class="row">
									<div class="col-xl-12">
										<div class="form-label-group">
											...
											<input type="text" id="ans" name="ans1" class="form-control" placeholder="Answer For Question1"  required>
										</div>
									</div>
								</div>
